...
var dicts = {
    ...
    'fas fa-utensils': ['restaurant', 'restaurants', 'Restaurants', 'Restaurant', 'RESTAURANT'],

    'fas fa-sitemap': ['organization', 'organizations'],
    ...
    'fas fa-users-cog' : ['Configuration', 'Configurations'], 
    'fas fa-globe-africa' : ['Countries', 'Country'], 
    'fas fa-bullhorn' : ['Activity', 'Activities'], 
    'fas fa-meteor' : ['Season', 'Seasons'], 
    'fas fa-concierge-bell' : ['Trigger', 'Triggers'], 
    'fas fa-boxes' : ['Project', 'Projects'], 
    'fas fa-street-view' : ['Farmer', 'Farmers'], 
    'fas fa-boxes' : ['Project', 'Projects'], 
    'fas fa-blender-phone' : ['Communication', 'Communications'],
    'fas fa-clock' : ['Schedule', 'Schedules'],
    'fas fa-book-reader' : ['Template', 'Templates'],
    'fas fa-clipboard-check' : ['Tracker', 'Tracker'],
    'fas fa-wallet' : ['Wallet Balancer Tracker', 'Wallet'],
    'fas fa-project-diagram' : ['Project', 'Projects'],
    'fas fa-user' : ['Farmer', 'Farmers'],
}